...
#     x = layers.Dropout(0.3)(x)
    output = layers.Dense(1, activation='sigmoid', kernel_initializer='he_normal')(x) #multi-class
#     # define the model 
...
# compile model
model.compile(loss='binary_crossentropy', optimizer=tf.keras.optimizers.Adam(learning_rate=var.lr), metrics=['accuracy'])
...
model.save('/projectnb/nickar/sidd/weight')
